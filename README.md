# chatbot-5.1-Echo&amp;FaceBot_withWaterfall

A waterfall dialog bot that can have the user talk to echo bot or use Azure Cognitive Services APIs for Image Analytics and Face Detection on image URLs
(use your own subscription kets and Endpoint URLs in API dialogs)
